...
- [ ] 디자인 게이트 2: 제품 청사진·성장 전략·보상 시스템·Hue Room 기준을 먼저 대조하고 네 방향의 무드보드·홈·3×3·방 질감 샘플을 비교해 상위 두 방향 선택하기
...
- [ ] M4~M5: Hue Room 시안 승인, 동적 SVG, 저장·재채색·Color Rhythm·실제 아이템 보상 완성하기
...
- [ ] 베타 사용자에게 B안의 중간 저장·재진입 부담과 8컷 완성감을 검증하고 후속 카피·버튼·보상 강도를 조정하기
