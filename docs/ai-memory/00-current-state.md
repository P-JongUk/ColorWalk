...
- 현재 최우선 목표: Color Hunt, 측정, 안전한 Color Relay, Hueprint/Color Capsule, 실제 배지 보상 등 성공 가능성을 만드는 실현 가능한 핵심 요소를 완성하고 품질·보안·실기기 QA를 통과해 최대한 빠르게 출시
...
- 현재 그래프: Graphify 0.9.23, 1,052개 노드와 1,052개 연결, 123개 community (2026-07-22 갱신)
